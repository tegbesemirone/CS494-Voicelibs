...
__all__ = [
    'SpMemoryStream', 'DISPID_SWFEChannels',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN',
    'SSSPTRelativeToCurrentPosition', 'SVEEndInputStream',
    'SPBO_PAUSE', 'DISPIDSPTSI_SelectionOffset', 'eLEXTYPE_PRIVATE16',
    'SPRS_ACTIVE', 'DISPID_SVSkip', 'SDTAll', 'SpStream',
    'DISPID_SPISaveToMemory', 'SPSMF_UPS',
    'DISPID_SPERetainedStreamOffset', 'DISPIDSPTSI_ActiveLength',
    'SVSFIsXML', '_ISpeechVoiceEvents', 'ISpAudio', 'SpMMAudioIn',
    'SAFTGSM610_44kHzMono', 'DISPID_SRGCmdSetRuleState',
    'SECNormalConfidence', 'SSFMOpenReadWrite', 'SVSFIsNotXML',
    'SpeechCategoryRecoProfiles', 'DISPID_SPIEngineId',
    'DISPID_SGRAddResource', 'DISPID_SPRFirstElement', 'SPSUnknown',
    'DISPID_SPAsItem', 'SVSFPersistXML', 'SPEVENTSOURCEINFO',
    'SpeechDictationTopicSpelling', 'SDKLDefaultLocation',
    'SAFTCCITT_uLaw_11kHzMono', 'STCInprocHandler',
    'ISpeechPhraseInfo', 'DISPID_SVAlertBoundary',
    'ISpeechPhraseReplacement', 'SVEPrivate', 'SDTDisplayText',
    'SpeechAudioVolume', 'SRTAutopause', 'ISpeechVoice',
    'SSSPTRelativeToStart', 'SpeechWordPronounceable',
    'DISPID_SPRuleId', 'SVP_15', 'DISPID_SGRsCommit',
    'DISPID_SADefaultFormat', 'DISPID_SLPLangId', 'SPEI_MIN_TTS',
    'DISPID_SLWWord', 'SP_VISEME_20', 'DISPID_SpeechVoiceStatus',
    'ISpDataKey', 'SP_VISEME_12', 'SDTAudio', 'SAFTADPCM_22kHzStereo',
    'SPRECOSTATE', 'DISPID_SDKDeleteKey', 'SAFT44kHz8BitMono',
    'ISpeechPhraseReplacements', 'DISPID_SVSRunningState',
    'SPPS_RESERVED4', 'SPCS_DISABLED', 'SVP_3', 'SpeechVoiceEvents',
    'SDTPronunciation', 'SREStateChange', 'SPPS_SuppressWord',
    'SpCompressedLexicon', 'SPSInterjection', 'DISPID_SLPsCount',
    'SAFT12kHz8BitStereo', 'DISPID_SASNonBlockingIO',
    'DISPID_SPIAudioSizeBytes', 'DISPID_SRIsUISupported',
    'SPEI_MIN_SR', 'SpeechAudioFormatGUIDWave',
    'DISPID_SOTGetStorageFileName', 'SPEI_MAX_TTS',
    'ISpeechMemoryStream', 'DISPID_SABIMinNotification',
    'DISPID_SPIRule', 'SAFTNoAssignedFormat',
    'DISPID_SGRSAddWordTransition', 'SAFTCCITT_uLaw_44kHzMono',
    'SPAUDIOSTATE', 'DISPID_SPIAudioStreamPosition',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'DISPID_SOTSetId',
    'DISPID_SVGetVoices', 'DISPID_SPAsCount', 'SRESoundEnd',
    'SpeechPropertyComplexResponseSpeed', 'SP_VISEME_5',
    'SPSHT_NotOverriden', 'ISpeechGrammarRules',
    'DISPID_SRGDictationLoad', 'SGRSTTEpsilon', 'SPAR_Unknown',
    'DISPID_SVAudioOutput', 'SSTTTextBuffer', 'SVP_7',
    'ISpObjectToken', 'SREStreamStart', 'eLEXTYPE_VENDORLEXICON',
    'SAFTCCITT_ALaw_22kHzStereo', 'SSFMCreate', 'DISPID_SLWsCount',
    ...
    'SPEI_WORD_BOUNDARY', 'eLEXTYPE_APP', 'SVSFNLPSpeakPunc',
    'DISPID_SGRAddState', 'DISPID_SpeechRecoResult2', 'SPSHT_EMAIL',
    'ISpeechPhraseRule', 'DISPID_SPEs_NewEnum', 'SPCT_DICTATION',
    'DISPID_SPCIdToPhone', 'SVP_14', 'SPAS_PAUSE',
    'DISPID_SRCEHypothesis', 'DISPID_SABIEventBias',
    'SPINTERFERENCE_NOSIGNAL', 'ISpeechPhraseRules', 'SPLO_DYNAMIC',
    'DISPID_SOTGetDescription', 'DISPID_SPEAudioStreamOffset',
    'SECLowConfidence', 'SVSFParseSsml', 'DISPID_SRCState',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'SAFT44kHz16BitStereo',
    'DISPID_SRGCmdLoadFromFile', 'ISpeechCustomStream',
    'SPPS_NotOverriden', 'tagSPTEXTSELECTIONINFO',
    'DISPID_SpeechMemoryStream', 'DISPID_SVAudioOutputStream',
    'SAFT22kHz8BitStereo', 'DISPID_SRProfile', 'SAFT16kHz16BitMono',
    'SPWAVEFORMATTYPE', 'DISPID_SWFEBlockAlign',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'DISPIDSPRG',
    'DISPID_SPRuleConfidence', 'SAFTGSM610_11kHzMono',
    'DISPID_SRGIsPronounceable', 'SITooLoud', 'SP_VISEME_0',
    'DISPID_SRState', 'ISpeechLexiconPronunciations',
    'SPPHRASEPROPERTY', 'DISPID_SLPsItem',
    'DISPID_SASCurrentSeekPosition', 'DISPID_SWFEBitsPerSample',
    'SPPS_Unknown', 'SpeechRecognizerState', 'DISPID_SRGetFormat',
    'SDA_One_Trailing_Space', 'SPINTERFERENCE',
    'DISPID_SRRGetXMLErrorInfo', 'DISPID_SRCVoice',
    'DISPID_SPEAudioSizeBytes', 'DISPID_SGRsFindRule',
    'SREPropertyStringChange', 'DISPID_SRCCreateGrammar',
    'DISPID_SRSetPropertyString', 'DISPID_SGRsDynamic',
    '_ISpeechRecoContextEvents', 'DISPID_SLPSymbolic', 'SGSExclusive',
    'DISPID_SVSyncronousSpeakTimeout', 'SAFT48kHz16BitStereo',
    'SpeechRecognitionType', 'SPLO_STATIC', 'DISPID_SRSAudioStatus',
    'SpAudioFormat', 'SPSLMA',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001',
    'DISPID_SRCreateRecoContext', 'SPVPRIORITY', 'SPAR_Medium',
    'SpNotifyTranslator', 'SpeechPropertyLowConfidenceThreshold',
    'SPVPRI_OVER', 'SpPhoneticAlphabetConverter', 'SITooFast',
    'SPPS_RESERVED3', 'SAFT22kHz16BitStereo', 'DISPID_SLGenerationId',
    'DISPID_SRRAudio', 'DISPID_SRSCurrentStreamNumber',
    'DISPID_SPRuleChildren', 'DISPID_SGRSTWeight',
    'DISPID_SLGetPronunciations', 'SSTTDictation', 'SpMMAudioOut',
    'SPEI_RESERVED6', 'DISPID_SDKGetBinaryValue',
    'SREPropertyNumChange', 'DISPID_SPRDisplayAttributes',
    'DISPID_SAFSetWaveFormatEx', 'SVP_20', 'SECFNoSpecialChars',
    'SPADAPTATIONRELEVANCE', 'SAFT8kHz16BitMono',
    'Speech_Max_Pron_Length', 'eLEXTYPE_PRIVATE19',
    'DISPID_SRGRecoContext', 'SAFTADPCM_44kHzStereo',
    'DISPID_SGRSTText', 'SPFM_CREATE_ALWAYS', 'DISPID_SGRSTs_NewEnum',
    ...
    'SRCS_Enabled', 'SPEI_UNDEFINED', 'SpSharedRecoContext',
    'DISPID_SRCEInterference', 'ISpeechRecoGrammar',
    'IInternetSecurityMgrSite', 'SpSharedRecognizer',
    'DISPID_SPAs_NewEnum', 'SGRSTTDictation', 'SVSFParseAutodetect',
    'SPWORDPRONOUNCEABLE', 'ISpRecognizer3', 'SVP_17',
    'DISPID_SpeechDataKey', 'DISPID_SRCEAdaptation',
    'SpeechEngineProperties', 'DISPID_SRSClsidEngine',
    'DISPID_SLAddPronunciation', 'DISPID_SPCPhoneToId',
    'DISPID_SMSSetData', 'SpeechRunState',
    'DISPID_SPEAudioTimeOffset', 'SVSFNLPMask', 'SPPARTOFSPEECH',
    'SECFIgnoreWidth', 'DISPID_SRCEAudioLevel', 'eWORDTYPE_ADDED',
    'DISPID_SOTs_NewEnum', 'SPEI_SOUND_START', 'DISPID_SRCEBookmark',
    'SVP_2', 'IInternetSecurityManager',
    'DISPID_SpeechGrammarRuleState', 'SPCT_SUB_COMMAND',
    'SPLOADOPTIONS', 'SpeechPropertyHighConfidenceThreshold',
    'SP_VISEME_16', 'ISpeechAudioStatus', 'DISPID_SDKSetBinaryValue',
    'DISPID_SVSLastStreamNumberQueued', 'SVSFVoiceMask',
    'SGLexicalNoSpecialChars', 'SRSEIsSpeaking', 'DISPID_SLWLangId',
    'DISPID_SRCResume', 'DISPID_SPIGetDisplayAttributes',
    'SPWT_LEXICAL', 'DISPID_SRGCmdLoadFromMemory',
    'SRSInactiveWithPurge', 'SpPhraseInfoBuilder', 'SREStreamEnd',
    'SVP_19', 'DISPID_SPRulesItem', 'DISPID_SGRSTPropertyName',
    'DISPID_SOTIsUISupported', 'eLEXTYPE_PRIVATE1', 'SGRSTTRule',
    'SPTEXTSELECTIONINFO', 'SP_VISEME_11', 'DISPID_SVGetAudioInputs',
    'ISequentialStream', 'ISpeechPhraseAlternates',
    'DISPID_SPPChildren', 'SPEI_END_SR_STREAM',
    'DISPID_SLWPronunciations', 'DISPID_SPPFirstElement', 'SINone',
    'DISPID_SPERetainedSizeBytes', 'DISPID_SpeechObjectTokens',
    'SAFT22kHz8BitMono', 'DISPID_SRGState', 'SPAUDIOSTATUS',
    'ISpStreamFormatConverter', 'eLEXTYPE_PRIVATE12',
    'SAFTCCITT_uLaw_44kHzStereo', 'SPSNoun', 'DISPID_SVEStreamEnd',
    'DISPID_SRCEStartStream', 'ISpeechBaseStream', 'SpeechTokenKeyUI',
    'DISPID_SLWs_NewEnum', 'SAFTADPCM_11kHzMono',
    'DISPID_SOTGetAttribute', 'SPEI_PHONEME',
    'SpeechTokenShellFolder', 'SLODynamic',
    'SpeechAudioFormatGUIDText', 'DISPID_SpeechXMLRecoResult',
    'SPEVENTENUM', 'SpeechPropertyResourceUsage',
    'SpeechCategoryVoices', 'DISPID_SPEDisplayAttributes',
    'DISPID_SASCurrentDevicePosition', 'SGRSTTTextBuffer',
    'eLEXTYPE_PRIVATE3', 'eLEXTYPE_USER_SHORTCUT',
    'eLEXTYPE_PRIVATE8', 'ISpRecoContext', 'ISpShortcut',
    ...
    'SPDKL_LocalMachine', 'SDTLexicalForm', 'SVSFIsFilename',
    'SpCustomStream', 'SFTInput', 'DISPID_SPRulesCount',
    'DISPID_SOTRemoveStorageFileName', 'DISPID_SDKDeleteValue',
    'SpMMAudioEnum', 'SpeechVisemeFeature', 'SAFTText',
    'SPRST_ACTIVE', 'ISpeechWaveFormatEx', 'SPPHRASE',
    'ISpXMLRecoResult', 'SPBO_AHEAD', 'ISpVoice', 'SGRSTTWord',
    'SpeechCategoryAudioIn', 'SPEI_PHRASE_START',
    'DISPID_SpeechGrammarRuleStateTransitions',
    'DISPID_SPEDisplayText', 'SAFT32kHz16BitStereo', 'SPGS_EXCLUSIVE',
    'SpeechVoiceSkipTypeSentence', 'SPWORDPRONUNCIATIONLIST',
    'SpeechTokenValueCLSID', 'SPEI_MAX_SR', 'SAFT32kHz8BitStereo',
    'SPSMF_SAPI_PROPERTIES', 'DISPID_SRCAudioInInterferenceStatus',
    'DISPID_SRRecognizer', 'DISPID_SVPause', 'SDTRule',
    'SPEI_START_SR_STREAM', 'SAFT12kHz16BitStereo',
    'DISPID_SPAStartElementInResult', 'DISPID_SVEEnginePrivate',
    'DISPID_SGRSTransitions', 'eLEXTYPE_PRIVATE5',
    'SAFT11kHz16BitMono', 'DISPID_SGRClear', 'ISpeechDataKey',
    'DISPID_SpeechFileStream', 'SVSFParseSapi', 'SVP_0',
    'SPFM_OPEN_READWRITE', 'DISPID_SLGetWords',
    'DISPID_SpeechPhraseInfo', 'SPGS_ENABLED',
    'DISPID_SpeechPhraseProperty',
    'ISpeechGrammarRuleStateTransitions', 'SRERecoOtherContext',
    'eLEXTYPE_PRIVATE7', 'SAFTCCITT_uLaw_22kHzMono',
    'DISPID_SVSLastBookmarkId', 'DISPIDSPTSI', 'SAFT11kHz8BitMono',
    'SAFT24kHz16BitMono', 'SSTTWildcard', 'IStream',
    'SAFT24kHz8BitMono', 'DISPID_SOTRemove', 'ISpeechLexiconWord',
    'SPINTERFERENCE_LATENCY_WARNING', 'DISPID_SVSLastBookmark',
    'SPEI_HYPOTHESIS', 'DISPID_SVEViseme',
    'SpeechEmulationCompareFlags', 'DISPID_SPPsItem',
    'SpeechStreamSeekPositionType', 'SPEI_RECOGNITION',
    'DISPID_SRCEEnginePrivate', 'SAFT16kHz8BitStereo',
    'SPLEXICONTYPE', 'DISPID_SGRName', 'DISPID_SRRTLength',
    'DISPID_SPRuleNumberOfElements', 'DISPID_SpeechPhraseReplacement',
    'eLEXTYPE_PRIVATE20', 'SRAInterpreter', 'ISpeechLexiconWords',
    'SPGS_DISABLED', 'eLEXTYPE_PRIVATE11', 'eLEXTYPE_PRIVATE6',
    'IEnumSpObjectTokens', 'SRTReSent', 'SPAR_Low', 'SPEI_ADAPTATION',
    'DISPID_SpeechPhraseAlternate', 'SP_VISEME_19', 'SECFDefault',
    'DISPID_SPRuleName', 'SVSFDefault', 'eLEXTYPE_LETTERTOSOUND',
    'DISPID_SVEBookmark', 'SVEPhoneme', 'DISPID_SDKCreateKey',
    'ISpeechAudioBufferInfo', 'SLOStatic', 'DISPID_SRCPause',
    'SAFTCCITT_ALaw_8kHzMono', 'DISPID_SOTDataKey',
    'DISPID_SPIGetText', 'SRSActive', 'SVPAlert', 'ISpStreamFormat',
    'DISPID_SLRemovePronunciationByPhoneIds', 'SPWORDTYPE',
    'DISPID_SVESentenceBoundary', 'DISPID_SBSFormat',
    ...
    'SpVoice', 'ISpeechRecoResultDispatch', 'DISPID_SPILanguageId',
    'SRERequestUI', 'DISPID_SpeechPhraseElements',
    'ISpSerializeState', 'DISPID_SPPsCount', 'DISPID_SDKSetLongValue',
    'SPRST_INACTIVE', 'SPSVerb', 'DISPID_SRCERequestUI',
    'SAFT48kHz16BitMono', 'SVP_8', 'DISPID_SRGDictationSetState',
    'DISPID_SRRTimes', 'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'DISPID_SRRTStreamTime', 'DISPID_SOTsCount', 'SASPause',
    'ISpObjectWithToken', 'SGRSTTWildcard', 'ISpeechRecoContext',
    'DISPID_SpeechVoice', 'SVSFUnusedFlags', 'SVP_21',
    'SPPS_RESERVED1', 'DISPID_SGRSTNextState', 'SPVISEMES',
    'DISPID_SPEAudioSizeTime', 'SpeechPartOfSpeech', 'SVF_None',
    'SPVOICESTATUS', 'SPCT_SLEEP', 'SpTextSelectionInformation',
    'DISPID_SVEPhoneme', 'SASStop', 'SVPNormal', 'SPEI_RESERVED2',
    'DISPID_SLPs_NewEnum', 'DISPID_SRGCmdSetRuleIdState',
    'DISPID_SRCRequestedUIType', 'DISPID_SRSSupportedLanguages',
    'STCRemoteServer', 'SINoise', 'SpeechDisplayAttributes',
    'SPEI_RECO_STATE_CHANGE', 'DISPID_SpeechCustomStream', 'SVP_4',
    'DISPID_SGRSTType', 'SpeechGrammarState',
    'DISPID_SPIAudioSizeTime', 'SPEI_PROPERTY_STRING_CHANGE',
    'SVP_10', 'DISPID_SPEEngineConfidence',
    'DISPID_SOTCreateInstance', 'SVEVoiceChange', 'SVP_6',
    'SPRST_NUM_STATES', 'SpeechVoiceSpeakFlags', 'SPPROPERTYINFO',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'SAFT32kHz16BitMono',
    'SpeechGrammarTagDictation', 'DISPID_SpeechVoiceEvent',
    'SPCT_COMMAND', 'SECHighConfidence', 'SPRS_ACTIVE_USER_DELIMITED',
    'DISPID_SOTCDefault', 'DISPID_SLRemovePronunciation',
    'SpeechInterference', 'SPDKL_DefaultLocation',
    'DISPID_SVSInputSentenceLength', 'SpeechTokenKeyFiles',
    'DISPID_SPIEnginePrivateData', 'SPSTREAMFORMATTYPE',
    'SVEWordBoundary', 'DISPID_SVEStreamStart',
    'ISpeechPhraseElement', 'ISpNotifyTranslator', 'SP_VISEME_21',
    'DISPID_SLWType', 'DISPID_SASState', 'eLEXTYPE_PRIVATE13',
    'SECFEmulateResult', 'SVEAllEvents', 'SpeechFormatType',
    'SPSHORTCUTPAIRLIST', 'SRAImport', 'SREAdaptation', 'ISpLexicon',
    'DISPID_SVSInputWordLength', 'SPEI_ACTIVE_CATEGORY_CHANGED',
    'SWPUnknownWordPronounceable', 'DISPID_SVSCurrentStreamNumber',
    'DISPID_SPEPronunciation', 'STSF_AppData', 'tagSTATSTG',
    'SPINTERFERENCE_NONE', 'SPAO_RETAIN_AUDIO', 'SpeechDiscardType',
    'DISPID_SREmulateRecognition', 'SpeechDataKeyLocation',
    'SAFTDefault', 'ISpPhrase', 'DISPID_SpeechRecoResult',
    ...
    'DISPID_SPACommit', 'DISPID_SpeechObjectToken',
    'SAFTADPCM_44kHzMono', 'DISPID_SOTsItem',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'SPEI_REQUEST_UI',
    'SP_VISEME_13', 'DISPID_SPEActualConfidence',
    'SpeechGrammarTagUnlimitedDictation', 'DISPID_SGRsItem',
    'DISPID_SWFESamplesPerSec', 'SAFT48kHz8BitMono',
    'DISPID_SPEsItem', 'DISPID_SVSpeak', 'DISPID_SVEAudioLevel',
    'DISPID_SASetState', 'SPSSuppressWord', 'SRTSMLTimeout',
    'DISPID_SRGReset', 'DISPID_SPPId', 'eLEXTYPE_PRIVATE15',
    'SPEI_VOICE_CHANGE', 'DISPID_SPIRetainedSizeBytes',
    'DISPID_SGRSRule', 'DISPID_SpeechLexiconProns',
    'Speech_StreamPos_Asap', 'SREAudioLevel', 'DISPID_SPCLangId',
    ...
    'DISPID_SASFreeBufferSpace', 'SpeechRecoEvents',
    'SAFT8kHz8BitMono', 'DISPID_SRCEPropertyStringChange',
    'DISPID_SRSetPropertyNumber', 'SPSNotOverriden',
    'SAFT24kHz16BitStereo', 'DISPID_SpeechBaseStream', 'ISpeechAudio',
    'SPEI_TTS_AUDIO_LEVEL', 'DISPID_SABufferNotifySize',
    'SPFM_CREATE', 'SpObjectTokenCategory',
    'DISPID_SPRuleFirstElement', 'DISPID_SVEVoiceChange',
    'DISPID_SDKGetStringValue', 'DISPID_SRGRules',
    'SPINTERFERENCE_TOOLOUD', 'ISpRecoGrammar2', 'STCAll',
    'SpeechAudioFormatType', 'SAFT11kHz16BitStereo',
    'SPSERIALIZEDPHRASE', 'SpeechVisemeType', 'SPRS_INACTIVE',
    'SAFTADPCM_11kHzStereo', 'SPCS_ENABLED', 'SVP_16', 'SPPS_LMA',
    'SpeechCategoryAudioOut', 'SP_VISEME_8', 'DISPID_SGRsAdd',
    'SBONone', 'ISpRecoContext2', 'SAFT11kHz8BitStereo',
    'ISpeechRecoResult2', 'SVP_5', 'SpShortcut',
    'DISPID_SpeechLexiconWord', 'SpeechPropertyResponseSpeed',
    'DISPID_SVSpeakStream', 'SVF_Stressed', 'eLEXTYPE_RESERVED6',
    'ISpGrammarBuilder', 'DISPID_SABufferInfo', 'DISPID_SFSClose',
    'SPFILEMODE', 'SAFTCCITT_ALaw_11kHzStereo', 'eLEXTYPE_RESERVED8',
    'SPWF_INPUT', 'DISPID_SRRAlternates', 'SRATopLevel',
    'DISPID_SAEventHandle', 'DISPID_SVIsUISupported',
    'DISPID_SBSWrite', 'DISPID_SpeechRecoResultTimes',
    'DISPID_SOTMatchesAttributes', 'SVEStartInputStream',
    'DISPID_SPPConfidence', 'UINT_PTR', 'SpeechAddRemoveWord',
    'ISpeechObjectToken', 'ISpeechAudioFormat',
    'DISPID_SpeechAudioFormat', 'DISPID_SPERequiredConfidence',
    'SPPS_RESERVED2', 'DISPID_SRGetPropertyString',
    'SDKLLocalMachine', 'DISPID_SpeechRecoContextEvents',
    'ISpRecoGrammar', 'DISPID_SRCEventInterests',
    'DISPID_SMSAMMHandle', 'ISpeechPhraseInfoBuilder',
    'DISPID_SVVoice', 'SpeechVoicePriority',
    'ISpeechLexiconPronunciation', 'DISPID_SpeechAudioBufferInfo',
    'SPGRAMMARSTATE', 'SVP_9', 'SPEI_RESERVED1', 'ISpStream',
    'SPGRAMMARWORDTYPE', 'SVF_Emphasis', 'SP_VISEME_17',
    'DISPID_SDKOpenKey', 'SPEI_RESERVED3', 'SPINTERFERENCE_NOISE',
    'ISpeechObjectTokenCategory', 'SVESentenceBoundary',
    'SPWT_DISPLAY', 'DISPID_SAFGetWaveFormatEx', 'SPPS_Interjection',
    'SAFT12kHz16BitMono', 'SVEAudioLevel', 'SVP_13',
    'DISPID_SRCCmdMaxAlternates', 'SASRun', 'DISPID_SPRuleParent',
    'DISPID_SGRs_NewEnum', 'DISPID_SLPType', 'SpeechBookmarkOptions',
    'SDA_Consume_Leading_Spaces', 'SP_VISEME_6', 'SP_VISEME_15',
    'DISPID_SVGetAudioOutputs', 'DISPID_SpeechPhoneConverter',
    'DISPID_SPIStartTime', 'DISPID_SRRRecoContext', 'SGLexical',
    'SAFTCCITT_uLaw_11kHzStereo', 'DISPID_SRGetPropertyNumber',
    'SpeechPropertyAdaptationOn', 'eLEXTYPE_PRIVATE17',
    'DISPID_SRRPhraseInfo', 'SpeechSpecialTransitionType',
    'Speech_StreamPos_RealTime', 'DISPID_SPARecoResult',
    'ISpObjectTokenCategory', 'ISpProperties',
    ...
    'SPDKL_CurrentUser', 'DISPID_SGRSTsItem', 'eLEXTYPE_PRIVATE2',
    'SRADefaultToActive', 'DISPID_SRRTOffsetFromStart',
    'SGDSActiveWithAutoPause', 'SpeechStreamFileMode',
    'SPSHT_Unknown', 'SPWORDPRONUNCIATION', 'SDA_No_Trailing_Space',
    'eLEXTYPE_RESERVED4', 'DISPID_SpeechPhraseAlternates',
    'SPCT_SUB_DICTATION', 'DISPID_SpeechGrammarRule',
    'DISPID_SRCERecognitionForOtherContext',
    'DISPID_SGRSAddRuleTransition', 'DISPID_SPIGrammarId',
    'SPINTERFERENCE_TOOQUIET', 'SDTAlternates',
    'SpeechCategoryPhoneConverters', 'SpeechRuleAttributes',
    'STSF_LocalAppData', 'DISPID_SPRsItem', 'IEnumString',
    'SAFT32kHz8BitMono', 'SAFTCCITT_uLaw_8kHzStereo',
    'SREPhraseStart', 'SPSModifier', 'SpeechCategoryRecognizers',
    'ISpeechRecoResult', 'SPVPRI_NORMAL', 'DISPID_SVResume',
    'DISPID_SVSInputWordPosition', 'SpeechGrammarWordType',
    'SPSEMANTICERRORINFO', 'DISPID_SpeechWaveFormatEx',
    'eLEXTYPE_USER', 'DISPIDSPTSI_ActiveOffset', 'SRAExport',
    'SpeechUserTraining', 'DISPID_SDKEnumValues',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'SpeechLoadOption', 'SVSFParseMask', 'SpResourceManager',
    'SPFM_OPEN_READONLY', 'SPRS_ACTIVE_WITH_AUTO_PAUSE',
    'DISPID_SPPName', 'ISpPhoneticAlphabetConverter',
    'SPPHRASEREPLACEMENT', 'DISPID_SpeechPhraseRule',
    'ISpResourceManager', 'SPPS_Modifier', 'eLEXTYPE_RESERVED10',
    ...
    'SSFMCreateForWrite', 'SPWF_SRENGINE', 'SPWT_PRONUNCIATION',
    'SPRST_INACTIVE_WITH_PURGE', 'DISPID_SVEWord',
    'SAFT8kHz8BitStereo', 'SpeechRetainedAudioOptions', 'SREPrivate',
    'SVPOver', 'ISpeechPhraseAlternate',
    'DISPID_SRCRetainedAudioFormat', 'Speech_Max_Word_Length',
    'SPPHRASEELEMENT', 'DISPID_SRRSetTextFeedback', 'SGDisplay',
    'DISPID_SVVolume', 'ISpeechMMSysAudio',
    'DISPID_SRGCmdLoadFromObject', 'SPPS_Noun',
    'ISpeechGrammarRuleState', 'SVSFlagsAsync', 'SpeechRuleState',
    'SDA_Two_Trailing_Spaces', 'SPRECOGNIZERSTATUS',
    'SAFT44kHz16BitMono', 'SP_VISEME_18', 'STCLocalServer',
    'DISPID_SpeechAudio', 'DISPID_SPPEngineConfidence',
    'SPAUDIOOPTIONS', 'SVSFPurgeBeforeSpeak', 'ISpeechRecognizer',
    'DISPID_SVSLastResult', 'DISPID_SPPParent', 'SRESoundStart',
    'SECFIgnoreKanaType', 'DISPID_SRGDictationUnload',
    'DISPID_SPRNumberOfElements', 'DISPID_SRIsShared', 'SP_VISEME_4',
    'DISPID_SVDisplayUI', 'DISPID_SPIReplacements',
    'SAFT44kHz8BitStereo', 'SREFalseRecognition', 'SpObjectToken',
    'DISPID_SOTCGetDataKey', 'SP_VISEME_9', 'SGDSActiveUserDelimited',
    'DISPID_SRCBookmark', 'SPPHRASERULE', 'DISPID_SGRSTPropertyValue',
    'SPCONTEXTSTATE', 'SPWT_LEXICAL_NO_SPECIAL_CHARS',
    'DISPID_SGRSTRule', 'SVP_12', 'SpStreamFormatConverter',
    'SPSEMANTICFORMAT', 'DISPID_SVEventInterests',
    'DISPID_SPIElements', 'SRARoot', 'ISpNotifySource',
    'SpeechGrammarTagWildcard', 'SpeechAllElements', 'SDTReplacement',
    'SAFTGSM610_22kHzMono', 'DISPID_SAFGuid', 'DISPID_SAStatus',
    'DISPID_SRDisplayUI', 'SRAONone', 'SPEI_SR_RETAINEDAUDIO',
    'SAFT16kHz8BitMono', 'DISPID_SpeechPhraseElement', 'SP_VISEME_7',
    'SPEI_SENTENCE_BOUNDARY', 'ISpeechTextSelectionInformation',
    'DISPID_SRCEPropertyNumberChange', 'DISPID_SRCERecognition',
    'SpWaveFormatEx', 'SPBOOKMARKOPTIONS', 'SLTUser',
    'SWPUnknownWordUnpronounceable', 'SPBINARYGRAMMAR', 'SPWORD',
    'SpInprocRecognizer', 'SPXMLRESULTOPTIONS', 'SGDSActive',
    'SITooQuiet', 'SPINTERFERENCE_TOOFAST', 'eLEXTYPE_PRIVATE14',
    'eLEXTYPE_PRIVATE18', 'SVP_1', 'SAFT12kHz8BitMono',
    'SpeechTokenContext', 'SAFT22kHz16BitMono', 'STCInprocServer',
    'SAFTCCITT_uLaw_22kHzStereo', 'DISPID_SPRuleEngineConfidence',
    'DISPID_SVSInputSentencePosition',
    'ISpeechGrammarRuleStateTransition', 'SVEViseme', 'SPRULESTATE',
    'SSFMOpenForRead', 'DISPID_SPPNumberOfElements', 'SREAllEvents',
    'SPSERIALIZEDRESULT', 'SP_VISEME_2', 'ISpeechResourceLoader',
    'SPRECOCONTEXTSTATUS', 'ISpRecoCategory',
    'DISPID_SpeechRecognizerStatus', 'SPEI_SOUND_END', 'SP_VISEME_10',
    'DISPID_SLPPartOfSpeech', 'SPXRO_Alternates_SML', 'SP_VISEME_14',
    'SPSHORTCUTPAIR', 'DISPID_SRRTTickCount',
    'SPSMF_SRGS_SAPIPROPERTIES', 'SpeechTokenKeyAttributes',
    'DISPID_SRGCommit', 'STSF_CommonAppData', 'SRTExtendableParse',
    'SpUnCompressedLexicon', 'SPXRO_SML', 'SPEI_SR_PRIVATE', 'SVP_18',
    'SAFTNonStandardFormat', 'SpeechRegistryLocalMachineRoot',
    'eLEXTYPE_RESERVED9', 'DISPID_SPRsCount',
    'DISPID_SRCRetainedAudio', 'SRSInactive', 'SBOPause',
    'SpeechLexiconType', 'DISPID_SPEsCount', 'SLTApp',
    'SRCS_Disabled', 'SVEBookmark', 'DISPID_SAFType',
    'SPBO_TIME_UNITS', 'DISPID_SLWsItem', 'DISPID_SMSGetData',
    'SVP_11', 'DISPID_SRAudioInputStream',
    'SpeechPropertyNormalConfidenceThreshold',
    'SPEI_START_INPUT_STREAM', 'DISPID_SDKGetlongValue', 'SPAS_STOP',
    'DISPID_SRCEEndStream', 'DISPID_SOTCategory',
    'DISPID_SGRSAddSpecialTransition', 'SGPronounciation',
    'DISPID_SOTDisplayUI', 'SP_VISEME_1',
    'DISPID_SpeechPhraseReplacements', 'SRSActiveAlways',
    'DISPID_SpeechGrammarRules', 'SITooSlow', 'SWTAdded',
    'DISPID_SRAudioInput', 'DISPID_SVPriority',
    'ISpPhoneticAlphabetSelection', 'SAFTCCITT_uLaw_8kHzMono',
    'DISPID_SOTCSetId', 'SASClosed', 'SPEVENT', 'ISpMMSysAudio',
    'SAFTTrueSpeech_8kHz1BitMono', 'SAFTADPCM_8kHzStereo',
    'SPVPRI_ALERT', 'SpLexicon', 'SPAO_NONE',
    ...
    'DISPID_SGRSTPropertyId', 'DISPID_SRCSetAdaptationData',
    'DISPID_SWFEExtraData', 'SPSHT_OTHER',
    'SpeechGrammarRuleStateTransitionType', 'SpFileStream',
    'SPWORDLIST', 'DISPID_SpeechLexicon', 'SREInterference',
    'SPAS_CLOSED', 'SpeechTokenIdUserLexicon', 'DISPID_SOTId',
    'SpeechAudioProperties', 'DISPID_SRGId', 'SGSDisabled',
    'SPEI_TTS_PRIVATE', 'SDTProperty', 'DISPID_SMSADeviceId',
    'SPAR_High', 'DISPID_SPPValue', '_RemotableHandle',
    'SPDKL_CurrentConfig', 'DISPID_SGRId', 'SpNullPhoneConverter',
    'DISPID_SMSALineId', 'DISPID_SPRText', 'DISPID_SRGetRecognizers',
    'DISPID_SPAPhraseInfo', 'SSSPTRelativeToEnd', '_SPAUDIOSTATE',
    'DISPID_SRRGetXMLResult', 'SECFIgnoreCase', 'SAFTADPCM_22kHzMono',
    'eWORDTYPE_DELETED', 'SREBookmark', 'SGDSInactive',
    'ISpeechGrammarRule', 'SDKLCurrentConfig', 'DISPID_SBSRead',
    'DISPIDSPTSI_SelectionLength', 'SRSEDone', 'SREHypothesis',
    'ISpeechPhoneConverter', 'DISPID_SpeechAudioStatus',
    'SPRST_ACTIVE_ALWAYS', 'SPRECORESULTTIMES', 'ISpPhoneConverter',
    'DISPID_SVRate', 'DISPID_SpeechLexiconWords', 'SPCATEGORYTYPE',
    'SPDATAKEYLOCATION', 'DISPID_SVGetProfiles',
    'DISPID_SVSpeakCompleteEvent', 'ISpeechPhraseElements',
    'DISPID_SABIBufferSize', 'ISpeechXMLRecoResult', 'SWTDeleted',
    'ISpEventSink', 'DISPID_SRRAudioFormat', 'DISPID_SGRsCount',
    'SAFTCCITT_ALaw_44kHzStereo', 'SPSFunction', 'SPEI_RESERVED5',
    'DISPID_SVSVisemeId', 'SWPKnownWordPronounceable',
    'DISPID_SBSSeek', 'SpeechCategoryAppLexicons', 'DISPID_SOTCId',
    'SpPhoneConverter', 'DISPID_SRCRecognizer', 'eLEXTYPE_PRIVATE9',
    'SAFTCCITT_ALaw_11kHzMono', 'DISPID_SRCEFalseRecognition',
    'SPEI_INTERFERENCE', 'SAFTCCITT_ALaw_8kHzStereo',
    'SPINTERFERENCE_TOOSLOW', 'SRADynamic', 'DISPID_SRCESoundEnd',
    'SpeechAudioState', 'ISpeechLexicon', 'DISPID_SRRSpeakAudio',
    'SPPS_Noncontent', 'DISPID_SPIProperties', 'LONG_PTR',
    'DISPID_SPRs_NewEnum', 'ISpEventSource', 'SINoSignal',
    '__MIDL_IWinTypes_0009', 'SGSEnabled', 'SPPS_Function',
    'SRAORetainAudio', 'SPEI_FALSE_RECOGNITION',
    'SAFT48kHz8BitStereo', 'SpeechWordType', 'DISPID_SRStatus',
    'DISPID_SDKEnumKeys', 'SFTSREngine', 'DISPID_SDKSetStringValue',
    'SPEI_PROPERTY_NUM_CHANGE', 'tagSPPROPERTYINFO',
    'DISPID_SAVolume', 'SPSHORTCUTTYPE', 'SPPS_Verb',
    'DISPID_SLPPhoneIds', 'SRERecognition', 'ISpeechRecognizerStatus',
    'ISpNotifySink', 'WAVEFORMATEX', 'SPEI_SR_AUDIO_LEVEL',
    'SAFT16kHz16BitStereo', 'SRTStandard', 'DISPID_SPRules_NewEnum',
    ...
    'SpeechEngineConfidence', 'eLEXTYPE_PRIVATE4', 'STSF_FlagCreate',
    'SPBO_NONE', 'DISPID_SpeechMMSysAudio', 'SPEI_END_INPUT_STREAM',
    'DISPID_SpeechLexiconPronunciation', 'DISPID_SFSOpen',
    'ISpRecoResult', 'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'ISpRecognizer',
    'SPEI_SR_BOOKMARK', 'DISPID_SRCCreateResultFromMemory',
    'SPFM_NUM_MODES', 'DISPID_SPPs_NewEnum',
